...
<body>
  ...
  <div id="legend" class="panel">
    ...
    <div class="legend-title">Station &rarr; Substation link</div>
    <div class="legend-item"><span class="legend-line" style="background:#4ade80;"></span><span>&le;25 km (economic)</span></div>
    <div class="legend-item"><span class="legend-line" style="background:#fbbf24;"></span><span>25&ndash;50 km</span></div>
    <div class="legend-item"><span class="legend-line" style="background:#f87171;"></span><span>&gt;50 km (remote site)</span></div>
  </div>
...
<script>
  ...
  setSwatch('swatch-links', 'rgba(255,255,255,0.55)', 'line');
  ...
  function render() {
    ...
    // 3. Station -> Substation connection lines (dotted).
    if (visible.links) {
      layers.push(new deck.PathLayer({
        id: 'links',
        data: links,
